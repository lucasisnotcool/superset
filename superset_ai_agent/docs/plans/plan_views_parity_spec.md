...
[`wren_upstream_skills/`](../reference/wren_upstream_skills) and the Wren docs.
...
- **Where Wren authors views.** *Not* in base onboarding. Onboarding only
  ...
  ([onboarding.SKILL.md:118](../reference/wren_upstream_skills/onboarding.SKILL.md#L118)).
  Views are added during:
  - **generate-mdl Phase 7 "Iterate"** — *"Adding views for common query
    patterns"* ([generate-mdl.SKILL.md:261](../reference/wren_upstream_skills/generate-mdl.SKILL.md#L261)).
  - **enrich-context** — a view is one sink in the
    ...
    ([cube_proposals.md:23-24](../reference/wren_upstream_skills/enrich-context.references.cube_proposals.md#L23)).
    Upstream treats a **new view as high-blast-radius → escalate/grill before
    applying** ([enrich-context.SKILL.md:35,143,187](../reference/wren_upstream_skills/enrich-context.SKILL.md#L35)).
...
1. **New reference, adapted from upstream cube_proposals (VIEW branch only).**
   ...
   [cube_proposals.md:15-27,90-91](../reference/wren_upstream_skills/enrich-context.references.cube_proposals.md#L15),
...
2. **`skills/enrich-context.md`** — add views as a Step 5 gap-catalog category and a
   ...
   [enrich-context.SKILL.md:143,149](../reference/wren_upstream_skills/enrich-context.SKILL.md#L143).
...
3. **`skills/generate-mdl.md`** — promote the L273 one-liner into a short "When to
   ...
   ([generate-mdl.SKILL.md:261](../reference/wren_upstream_skills/generate-mdl.SKILL.md#L261)) +
