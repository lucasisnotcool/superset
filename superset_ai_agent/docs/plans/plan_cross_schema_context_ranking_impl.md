...
**Status:** SHIPPED (Fix A join-closure + Fix B unbiased ranking; see
`tests/unit_tests/superset_ai_agent/test_join_closure.py`. Header corrected
2026-07-03; it previously said "proposed".) · **Date:** 2026-06-29
