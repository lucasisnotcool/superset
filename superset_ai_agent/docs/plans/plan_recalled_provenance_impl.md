...
**Status:** IMPLEMENTED (status added 2026-07-03 — verified in code:
`explain.py` stamps `source: golden|memory` on recalled examples; the tail of
this doc records as-built notes and accepted gaps).
